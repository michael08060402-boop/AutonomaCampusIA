...
import { Mail, Calendar, GraduationCap, Shield, User, Pencil, Check, X, Loader2, Camera } from "lucide-react";
...
export default function PerfilPage() {
  ...
  const [firstName, setFirstName] = useState("Estudiante");
  ...
  useEffect(() => {
    async function load() {
      ...
      setFirstName(capitalized.split(" ")[0] || "Estudiante");
      setEmail(user.email ?? "");
        ...
        <div className="px-6 pb-6 pt-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            {[
              ...
              { icon: GraduationCap, label: "Rol en la plataforma", value: "Estudiante" },
