    ...
    <div className="p-8">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden mb-5">
        ...
        <div className="px-6 py-5 space-y-4">
          {[
            { label: "Nuevas entregas", desc: "Cuando un estudiante entregue una tarea" },
            { label: "Nuevas inscripciones", desc: "Cuando alguien se inscriba en tu curso" },
            { label: "Mensajes de soporte", desc: "Respuestas del equipo de AutonomaCampus" },
